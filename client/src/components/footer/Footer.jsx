                ...
                <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
                    <div class="text-center">
                        ...
                        <p class="mx-auto mt-4 max-w-sm text-gray-500">
                            The ultimate platform for secret confessions and one-time
                            messages. Share your thoughts anonymously, send private messages
                            that disappear after being read, and experience true digital
                            secrecy.
                        </p>
